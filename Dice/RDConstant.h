...
//Version
static const std::string Dice_Ver = "Base on Dice 2.3.6";
static const std::string Dice_Short_Ver = "By 旧日酱 " + Dice_Ver;
static const std::string Dice_Head_Ver = "<" + Dice_Short_Ver + ">";
static const std::string Dice_Full_Ver = "旧日的儿子 DiceJRS\n" + Dice_Head_Ver;
static const std::string Dice_Bot_Ver = "我，是旧日的儿子！有何贵干？";
//Error Handle
#define Value_Err (-1)
#define Input_Err (-2)
...
static std::string LongInsanity[11]{
	...
	"[狂躁]\n调查员患上一个新的狂躁症，在{0}小时后恢复理智。在这次疯狂发作中，调查员将完全沉浸于其新的狂躁症状。这是否会被其他人理解（apparent to other people）则取决于守秘人和此调查员。\n{1}\n具体狂躁症: {2}(守秘人也可以自行从狂躁症状表中选择其他症状)"
};
